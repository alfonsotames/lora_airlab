...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_RTC_STM32, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_LL_EXTI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_LL_I2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_LL_PWR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHT3XD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHT3XD_TRIGGER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHT3XD_REPEATABILITY_HIGH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHT3XD_PERIODIC_MODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHT3XD_MPS_1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_INIT_PRIORITY, 65);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_RTC_STM32_CLOCK_LSI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_RTC_STM32_BACKUP_DOMAIN_RESET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_MAXIM_DS3231, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORAWAN_LOG_LEVEL_INF, 1);
